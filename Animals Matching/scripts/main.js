...
document.addEventListener("DOMContentLoaded", function() {
  const videoSrc = window.innerWidth < 768 ? "images/intromob.mp4" : "images/intro.mp4"; // Directly set the video source
  ...
  video.id = "introVideo";
  video.width = 1350; // Set width for portrait mode
  video.height = 950; // Set height for portrait mode
...
brandingImage.src = 'images/thappa.png'; // Path to the branding image
brandingImage.alt = 'thappa'; // Alt text for accessibility
brandingImage.style.position = 'fixed'; // Fixed position
brandingImage.style.bottom = '10px'; // Position from the bottom
brandingImage.style.right = '150px'; // Position from the right
